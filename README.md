...
1. Open `LFP3_szd5538.asm` in MARS.
2. Open **Tools > Bitmap Display** and use these settings:
...
3. Click **Connect to MIPS** in the Bitmap Display.
4. Open **Tools > Keyboard and Display MMIO Simulator**.
5. Click **Connect to MIPS** in the MMIO Simulator.
6. Assemble and run the program.
7. Use keys `1` through `9` to repeat the displayed sequence.
